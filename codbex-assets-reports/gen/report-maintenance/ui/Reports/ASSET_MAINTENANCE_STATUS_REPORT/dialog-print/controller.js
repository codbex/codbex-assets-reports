angular.module('page', ["ideUI", "ideView", "entityApi"])
    .config(["messageHubProvider", function (messageHubProvider) {
        messageHubProvider.eventIdPrefix = 'codbex-assets-reports.Reports.ASSET_MAINTENANCE_STATUS_REPORT';
    }])
    .config(["entityApiProvider", function (entityApiProvider) {
        entityApiProvider.baseUrl = "/services/ts/codbex-assets-reports/gen/report-maintenance/api/ASSET_MAINTENANCE_STATUS_REPORT/ASSET_MAINTENANCE_STATUS_REPORTService.ts";
    }])
    .controller('PageController', ['$scope', 'messageHub', 'entityApi', 'ViewParameters', function ($scope, messageHub, entityApi, ViewParameters) {
        ...
        window.onafterprint = () => {
            messageHub.closeDialogWindow("codbex-assets-reports-Reports-ASSET_MAINTENANCE_STATUS_REPORT-print");
        }
